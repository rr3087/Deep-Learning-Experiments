...
model = Sequential()
# model.add(Conv1D(4700, kernel_size=5, padding='same', input_shape=(47,1), activation='tanh'))
# model.add(Dropout(0.5))
# model.add(Conv1D(2048, kernel_size=3, padding='same'))
# # model.add(BatchNormalization())
# model.add(Activation('tanh'))
# model.add(Dropout(0.4))
# # model.add(Dropout(0.4))
# model.add(Conv1D(1024, kernel_size=3, padding='same', activation='tanh'))
...
model.add(GRU(705, input_shape=(47,1), activation='tanh', return_sequences=True))
model.add(BatchNormalization())
...
model.fit(Xtrain, ytrain, epochs=100, batch_size=100, validation_data=(Xtest, ytest), verbose=1) ## try with a different batch size maybe 50

model.optimizer.lr.assign(0.1)
model.fit(Xtrain, ytrain, epochs=50, batch_size=100, validation_data=(Xtest, ytest), verbose=1)
